...
export const methods: { [key: string]: (...any: any) => any } = {
    ...
    async createPrefabFromNode(nodeUuid: string, prefabPath: string) {
        try {
            const prefabManager = (globalThis as any).cce?.Prefab;
            const createPrefabAssetFromNode = prefabManager?.createPrefabAssetFromNode;
            ...
            const prefabUuid = await createPrefabAssetFromNode.call(
                prefabManager,
                nodeUuid,
                prefabPath,
            );
